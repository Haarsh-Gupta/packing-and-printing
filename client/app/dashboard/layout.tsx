...
import { LayoutDashboard, Package, FileText, Settings, LogOut, ChevronLeft, ChevronRight, Menu, X, MessageSquare, Home, ClipboardCheck, Users } from "lucide-react";
...
export default function DashboardLayout({
    ...
    return (
        <div className="flex min-h-screen bg-site-bg relative overflow-x-hidden">
