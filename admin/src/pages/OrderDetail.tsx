        ...
        <div className="flex flex-col font-['Inter'] animate-fade-in bg-slate-50 dark:bg-[#0b1326] -m-8 p-8 min-h-screen text-slate-900 dark:text-[#dae2fd]">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center justify-between mb-10 gap-6">
                ...
                <div className="flex items-center gap-3">
                    <button className="bg-white dark:bg-[#131b2e] hover:bg-slate-50 dark:hover:bg-[#171f33] text-blue-600 dark:text-[#adc6ff] border border-slate-200 dark:border-[#434655]/30 px-5 py-2.5 rounded-xl text-xs font-bold uppercase tracking-widest transition-all shadow-sm flex items-center gap-2">
                        <Printer size={16} />
                        Invoice
                    </button>
