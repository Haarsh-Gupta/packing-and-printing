...
export default function Products() {
    ...
    const handleSave = async () => {
        ...
        if (editingProduct) {
            // Calculate delta
            payload = {};
            if (formState.name !== editingProduct.name) payload.name = formState.name;
            if (formState.description !== (editingProduct.description || "")) payload.description = formState.description;
            if (formState.cover_image !== (editingProduct.cover_image || "")) payload.cover_image = formState.cover_image;
            if (formState.is_active !== editingProduct.is_active) payload.is_active = formState.is_active;
            if (formState.slug !== editingProduct.slug) payload.slug = formState.slug;
