            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
                <div>
                    <nav className="flex items-center gap-2 text-[10px] font-bold text-[#adc6ff] mb-2 tracking-widest uppercase">
                        ...
                        <span>/</span>
                        <span className="text-[#c3c5d8]/60">Dispatch Log</span>
                    </nav>
                ...
                <div className="relative">
                    ...
                    <input
                        ...
                        className="h-10 pl-9 pr-3 w-72 border border-[#434655]/40 rounded-lg text-xs font-mono text-[#adc6ff] bg-[#131b2e] outline-none focus:border-[#adc6ff] placeholder:text-[#434655]/70 transition-colors"
                    />
                </div>
            </div>
            ...
            <div className="bg-[#131b2e] rounded-2xl border border-[#434655]/20 flex flex-col flex-1 overflow-hidden min-h-[400px]">
                <div className="overflow-x-auto custom-scrollbar flex-1">
                    <table className="w-full border-collapse text-left">
                        <thead className="bg-[#060e20]/50 border-b border-[#434655]/20">
                            <tr>
                                <th className="px-6 py-4 text-[10px] uppercase font-bold tracking-[0.2em] text-[#c3c5d8]">Epoch</th>
                                <th className="px-6 py-4 text-[10px] uppercase font-bold tracking-[0.2em] text-[#c3c5d8]">Target Node</th>
                                <th className="px-6 py-4 text-[10px] uppercase font-bold tracking-[0.2em] text-[#c3c5d8]">Payload Subject</th>
                                <th className="px-6 py-4 text-[10px] uppercase font-bold tracking-[0.2em] text-[#c3c5d8]">Event State</th>
                            </tr>
                        </thead>
                        <tbody className="divide-y divide-[#434655]/10">
                            {loading ? (
                                <tr>
                                    <td colSpan={4} className="p-16 text-center text-[#c3c5d8] font-bold tracking-widest text-[10px] uppercase">
                                ...
                                <tr>
                                    <td colSpan={4} className="p-16 text-center text-[#c3c5d8]/50 font-bold tracking-widest text-[10px] uppercase">
                                        <Mail size={32} className="opacity-20 mx-auto mb-3 block" />
                                        <p>No dispatch events matching query parameters.</p>
                                    </td>
                                </tr>
                            ) : filtered.map((log) => (
                                <tr key={log.id} className="group hover:bg-[#171f33]/80 transition-colors">
                                    ...
                                    <td className="px-6 py-5">
                                        <div className="text-sm font-extrabold text-[#dae2fd] flex items-center gap-2">
                                            {log.recipient}
                                            <button className="text-[#434655] hover:text-[#adc6ff] p-0.5 rounded opacity-0 group-hover:opacity-100 transition-opacity">
                                                <ArrowUpRight size={14} />
                                            </button>
                                        </div>
                                        <div className="text-[10px] text-[#adc6ff] bg-[#adc6ff]/5 px-1.5 py-0.5 rounded border border-[#adc6ff]/10 font-mono tracking-widest inline-block mt-1.5">
                                            MSG_{log.message_id.slice(0, 12)}...
                                        </div>
                                    </td>
                                    <td className="px-6 py-5 text-[13px] text-[#c3c5d8] font-medium max-w-sm truncate">
                                        {log.subject}
                                    </td>
                                    <td className="px-6 py-5">
