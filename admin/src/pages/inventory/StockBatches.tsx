...
import { Loader2, Plus, Save, ArrowDownToLine, Eye } from "lucide-react";
            ...
            <div className="bg-white dark:bg-[#131b2e] rounded-2xl border border-slate-200 dark:border-[#434655]/20 overflow-hidden">
                <table className="w-full text-left border-collapse">
                    ...
                    <tbody className="divide-y divide-slate-100 dark:divide-[#434655]/10">
                        {loading ? (
                            <tr><td colSpan={8} className="text-center py-12 text-xs text-slate-500 dark:text-[#c3c5d8]"><Loader2 className="animate-spin inline mr-2" size={14} />Loading…</td></tr>
                        ) : batches.length === 0 ? (
                            <tr><td colSpan={8} className="text-center py-12 text-xs text-slate-400 dark:text-[#c3c5d8]/50">No batches found.</td></tr>
                        ) : batches.map(b => {
                            ...
                            return (
                                <tr key={b.id} className="hover:bg-slate-50 dark:hover:bg-[#171f33]/80 transition-colors">
