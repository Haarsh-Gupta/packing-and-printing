            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
                ...
                <div className="flex p-1 bg-white dark:bg-[#131b2e] border border-slate-200 dark:border-[#434655]/30 rounded-lg">
                    <button
                        ...
                        className={`flex items-center gap-2 px-5 py-2 rounded text-[10px] font-bold uppercase tracking-widest transition-colors ${mode === "SINGLE"
                    ...
                    <button
                        ...
                        className={`flex items-center gap-2 px-5 py-2 rounded text-[10px] font-bold uppercase tracking-widest transition-colors ${mode === "BULK"
                                ? 'bg-[#1f70e3] text-white shadow-sm'
                                : 'bg-transparent text-slate-500 dark:text-[#8d90a1] hover:text-slate-900 dark:hover:text-[#dae2fd]'
                            }`}
                    >
                    ...
                    <div className="p-6 overflow-y-auto custom-scrollbar flex flex-col gap-5">
                                            ...
                                            filteredUsers.length === 0 ? <div className="p-3 text-[10px] uppercase font-bold text-[#434655] tracking-widest">No nodes match signature</div> :
                                                filteredUsers.map(u => (
                                                    <div
                                                        ...
                                                        className={`p-2 px-4 text-xs cursor-pointer border-b border-slate-200 dark:border-[#434655]/10 last:border-0 ${toEmail === u.email
                        ...
                        <div className="mt-8 pt-6 border-t border-slate-200 dark:border-[#434655]/20">
                            ...
                            <button
                                onClick={handleSend}
                                disabled={sending}
                                className={`w-full h-12 rounded-xl text-[11px] font-extrabold uppercase tracking-widest flex items-center justify-center gap-2 transition-all shadow-[0_4px_12px_rgba(173,198,255,0.2)] ${sending
