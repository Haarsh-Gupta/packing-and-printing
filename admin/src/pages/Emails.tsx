    ...
    return (
        <div className="flex flex-col h-full font-['Inter'] bg-[#0b1326] text-[#dae2fd] px-2 pb-12 animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between mb-8 gap-4">
                <div>
                    <nav className="flex items-center gap-2 text-[10px] font-bold text-[#adc6ff] mb-2 tracking-widest uppercase">
                        ...
                        <span>/</span>
                        <span className="text-[#c3c5d8]/60">Compiler</span>
                    </nav>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-[450px_1fr] gap-6 flex-1 min-h-[600px]">
                ...
                {/* Editor Block */}
                <div className="bg-[#131b2e] rounded-2xl border border-[#434655]/20 flex flex-col overflow-hidden shadow-sm">
                    <div className="px-6 py-4 border-b border-[#434655]/20 bg-[#060e20]/50 flex items-center gap-3">
                        <Type size={16} className="text-[#adc6ff]" />
                    ...
                    <div className="p-6 overflow-y-auto custom-scrollbar flex flex-col gap-5">
                        ...
                        <div className="flex flex-col gap-2">
                            ...
                            <select 
                                ...
                                className="w-full h-11 rounded-lg border border-[#434655]/40 px-3 text-sm font-bold bg-[#0b1326] text-[#dae2fd] outline-none focus:border-[#adc6ff] transition-colors"
                            >
                        ...
                        {mode === "SINGLE" && (
                            <div className="flex flex-col gap-2">
                                <label className="text-[10px] font-bold uppercase tracking-widest text-[#c3c5d8]">Target Identity</label>
                                <div className="relative">
                                    ...
                                    <input 
                                        ...
                                        className="w-full h-11 rounded-t-lg border-b-0 border border-[#434655]/40 pl-9 pr-3 text-xs font-mono bg-[#0b1326] text-[#adc6ff] outline-none focus:border-[#adc6ff] transition-colors placeholder:text-[#434655]"
                                    />
                                    <div className="border border-[#434655]/40 border-t-[#434655]/20 max-h-[160px] overflow-y-auto custom-scrollbar rounded-b-lg bg-[#0b1326]">
                                        {fetchingUsers ? <div className="p-3 text-[10px] uppercase font-bold text-[#434655] tracking-widest">Scanning network...</div> : 
                                         ...
                                         filteredUsers.map(u => (
                                            <div 
                                                ...
                                                className={`p-2 px-4 text-xs cursor-pointer border-b border-[#434655]/10 last:border-0 ${
                                                    toEmail === u.email 
                                                        ? 'bg-[#1f70e3]/10 text-[#adc6ff]' 
                                                        : 'hover:bg-[#171f33] text-[#c3c5d8]'
                                                }`}
                                            >
                                ...
                                <div className="text-[10px] uppercase font-bold text-[#8d90a1] tracking-widest mt-1">
                                    Locked Target: <span className="text-[#adc6ff]">{toEmail || 'NONE'}</span>
                                </div>
                            </div>
                        )}
                        ...
                        <div className="flex flex-col gap-2">
                            <label className="text-[10px] font-bold uppercase tracking-widest text-[#c3c5d8]">Subject Line <span className="text-[#ffb4ab]">*</span></label>
                            <input 
                        ...
                        {templateId === "custom" && (
                            <>
                                <div className="flex flex-col gap-2">
                                    <label className="text-[10px] font-bold uppercase tracking-widest text-[#c3c5d8]">H1 Block <span className="text-[#ffb4ab]">*</span></label>
                                    <input 
                                ...
                                <div className="flex flex-col gap-2">
                                    <label className="text-[10px] font-bold uppercase tracking-widest text-[#c3c5d8]">Body Paragraph <span className="text-[#ffb4ab]">*</span></label>
                                    <textarea 
                                        placeholder="Enter core transmission text..."
                                        value={message} onChange={e => setMessage(e.target.value)}
                                        className="w-full min-h-[100px] rounded-lg border border-[#434655]/40 p-3 text-sm bg-[#0b1326] text-[#dae2fd] outline-none resize-y focus:border-[#adc6ff] transition-colors placeholder:text-[#434655]"
                                    />
                                </div>

                                <div className="flex flex-col gap-2">
                                    <label className="text-[10px] font-bold uppercase tracking-widest text-[#c3c5d8] flex items-center gap-2"><ImageIcon size={12} /> Graphics Vector</label>
                                    <input 
                                        type="url" placeholder="https://..."
                                        value={imageUrl} onChange={e => setImageUrl(e.target.value)}
                                        className="w-full h-11 rounded-lg border border-[#434655]/40 px-3 text-xs font-mono bg-[#0b1326] text-[#adc6ff] outline-none focus:border-[#adc6ff] transition-colors placeholder:text-[#434655]"
                                    />
                                </div>

                                <div className="grid grid-cols-2 gap-4">
                                    <div className="flex flex-col gap-2">
                                        <label className="text-[10px] font-bold uppercase tracking-widest text-[#c3c5d8]">CTA Label</label>
                                        <input 
                                    ...
                                    <div className="flex flex-col gap-2">
                                        <label className="text-[10px] font-bold uppercase tracking-widest text-[#c3c5d8] flex items-center gap-2"><LinkIcon size={12} /> CTA Link</label>
                                        <input 
                                            type="url" placeholder="https://..."
                        ...
                        <div className="mt-8 pt-6 border-t border-[#434655]/20">
                            {success && (
                            ...
                            <button 
                                ...
                                className={`w-full h-12 rounded-xl text-[11px] font-extrabold uppercase tracking-widest flex items-center justify-center gap-2 transition-all shadow-[0_4px_12px_rgba(173,198,255,0.2)] ${
                                    sending 
                                        ? 'bg-[#434655]/40 text-[#8d90a1] cursor-not-allowed shadow-none' 
                ...
                <div className="bg-[#131b2e] rounded-2xl border border-[#434655]/20 flex flex-col overflow-hidden shadow-sm">
                    <div className="px-6 py-4 border-b border-[#434655]/20 bg-[#060e20]/50 flex items-center justify-between">
                        <div className="flex items-center gap-3">
                            <Eye size={16} className="text-[#8d90a1]" />
                            <h2 className="text-[11px] uppercase tracking-widest font-extrabold text-[#dae2fd] m-0">Output Test Render</h2>
                        </div>
                        {loadingPreview && <Loader2 size={16} className="animate-spin text-[#adc6ff]" />}
                    </div>
                    <div className="flex-1 p-8 bg-[#0b1326] flex items-center justify-center">
                        <div className="bg-white w-full max-w-[600px] h-full min-h-[500px] rounded-xl overflow-hidden shadow-2xl border border-[#434655]/40 relative">
                             <iframe 
                                title="Email Preview"
