...
from app.modules.inventroy.models import UnitType, MaterialType, OwnerType, TransactionType
...
class MaterialCreate(BaseModel):
    ...
    uom: UnitType
    attributes: Optional[MaterialAttributesValidation] = Field(default_factory=dict)
